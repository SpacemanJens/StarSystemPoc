    ...
    drawSpacecraft() {
      ...
      if (onLocalScreenArea(xLocal, yLocal)) {
        ...
        if (!shared.showGrafics) {
          ...
          let col = (this.team === 'blue') ? 'blue' : 'green'
          ...
          let spacecraftCenterX = screenLayout.xGameArea + xLocal + 5
          let spacecraftCenterY = screenLayout.yGameArea + yLocal + 5;
  
          fill(col);
          ellipse(spacecraftCenterX, spacecraftCenterY, 30, 30);
          noStroke();
  
          const shouldRevealRank = this.isRevealed || this.id === me.id || this.status === 'inBattle' || shared.gameState === 'GAME-FINISHED';
          //if (shouldRevealRank && this.characterId) {
            ...
            text(this.characterId, spacecraftCenterX, spacecraftCenterY);
          //}
  //        fill(200);
          textSize(10);
          textAlign(CENTER, BOTTOM);
          text(this.playerDisplayName || '?', spacecraftCenterX, spacecraftCenterY + this.size / 2 + 12);
    ...
    drawScore(offSetX, offSetY) {
      ...
      text(this.playerName + " (My hits: " + playerHits + ", Hit by others: " + hitByOthers * -1 + ", Hit by canons: " + canonHits + ") - Planet: " + this.planetIndex, offSetX, offSetY);
    ...
    checkBulletCollision(bullet, playerXGlobal, playerYGlobal) {
      console.log("checkBulletCollision", bullet, playerXGlobal, playerYGlobal);
